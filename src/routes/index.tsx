    ...
    <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
        <div className="absolute inset-0 opacity-20">
          <img
            src="/images/greyfoam-hero.png"
            alt="Person sleeping on bed peacefully"
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 px-6 py-20 text-center">
          ...
          <p className="max-w-2xl text-base text-white/80 sm:text-lg">
            Premium foam essentials designed for deeper rest and brighter
            mornings.
          </p>
      ...
      >
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Multi-layer airflow channels keep you cool while you drift into
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Responsive, supportive foam cushions pressure points so you wake up
            refreshed.
          </p>
        </div>
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Thoughtfully sourced fabrics and fills for comfort you can feel good
            about.
          </p>
        </div>
      </section>
